...
export const GameActionTypes = {
    ...
    SET_WAITING_FOR_PLAYERS: "SET_WAITING_FOR_PLAYERS",
    SET_WAITING_TIME_UNTIL: "SET_WAITING_TIME_UNTIL",
    ...
    JOIN_PLAYER_SUCCESS: "JOIN_PLAYER_SUCCESS",
    JOIN_PLAYER_FAILURE: "JOIN_PLAYER_FAILURE",
...
export interface IGameState {
    ...
    waitingTimeUntil: number, // time in ms
}